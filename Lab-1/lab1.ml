...
you'd like.
......................................................................*)
let exercise5a () = 5. ** (3. ** 2.) ;;
let exercise5b () = (5. ** 3.) ** 2. ;;
(*======================================================================
...
let frustrum_volume a b c =
  ...
  let s a = a * a in
  let h = b in 3.1416
  *. h /. float_of_int 3*. (a *. a +. c  *.  c+.a *. c) in a ;;
...
let frustrum_volume a b c =
  ((3.1416 *. c) /. float_of_int 3) *. (a *. a +. c  *. c +. a *. c) ;;
...
let frustrum_volume (radius1 : float) (radius2 : float) (height : float)
  : float =
  ((3.1416 *. height) /. float_of_int 3) *. (radius1 *. radius1 +.
                                             height  *. height +.
                                             radius1 *. height) ;;
